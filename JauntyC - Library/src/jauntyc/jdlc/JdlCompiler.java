...
import jauntyc.analysis.lexer.StandardLexer;
import jauntyc.analysis.parser.EditableParser;
import jauntyc.analysis.parser.StandardParser;
import jauntyc.analysis.parser.exception.InfiniteRecursionException;
import jauntyc.analysis.parser.exception.InvalidRuleNameException;
...
/**
 * Define the Jaunty Definition Language Compiler. This class is used to compile
 * the files that specify the lexicon and the grammar of a language using the Jaunty Definition Language.
 * 
...
public class JdlCompiler {
	...
	//creates the lexer, the parser and the compiler for the Jaunty Definition Language
